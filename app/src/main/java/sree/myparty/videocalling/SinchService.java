package sree.myparty.videocalling;
...
public class SinchService extends Service {
    ...
    private static final String APP_KEY = "62f391cf-ee5e-416c-afca-cd445fe0905c";
    private static final String APP_SECRET = "Tcyir7mizkGZargkKqepVA==";
