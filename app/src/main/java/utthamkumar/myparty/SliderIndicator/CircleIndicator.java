...
public class CircleIndicator extends LinearLayout {
    ...
    private final OnPageChangeListener mInternalPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (mLastPosition >= 0 && (currentIndicator = getChildAt(mLastPosition)) != null) {
                currentIndicator.setBackgroundResource(R.drawable.side_nav_bar);
            ...
            if (selectedIndicator != null) {
                selectedIndicator.setBackgroundResource(R.drawable.side_nav_bar);
    ...
    private void createIndicators() {
        ...
        for (int i = 0; i < count; i++) {
            if (currentItem == i) {
                addIndicator(orientation, R.drawable.side_nav_bar, mImmediateAnimatorOut);
            } else {
                addIndicator(orientation, R.drawable.side_nav_bar,
    ...
    private void addIndicator(int orientation, @DrawableRes int backgroundDrawableId,
        ...
        Indicator.setBackgroundResource(R.drawable.side_nav_bar);
