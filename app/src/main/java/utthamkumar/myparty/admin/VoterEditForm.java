...
import utthamkumar.myparty.Adapters.CasteWiseVotersAdapter;
...
public class VoterEditForm extends AppCompatActivity {
    ...
    TextView spin_lastVoted;

    @BindView(R.id.cwv_nextVote)
    TextView spin_nextVote;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voter_edit_form);
        ...
        addedLocation = mVoter.getAdded_location();
        location = mVoter.getLocation();

        edt_location.setText(location.getLatitude() + "," + location.getLongitude());
    ...
    public void onButtonClick(View v) {
        ...
        catageory = spn_catageory.getText().toString();
        ...
        lastVoted = spin_lastVoted.getText().toString();
        nextVote = spin_nextVote.getText().toString();
...
//            Snackbar.make(null,"Validations are good",Snackbar.LENGTH_SHORT).show();
    ...
    public void save(VoterPojo mVoter) {
        String key = Constants.voter_key;
        mDialog.show();
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(VoterEditForm.this,
