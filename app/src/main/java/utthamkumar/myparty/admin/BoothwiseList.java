...
public class BoothwiseList extends AppCompatActivity {


    @BindView(R.id.spin_committees)
    Spinner spin_committees;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boothwise_list);
        ButterKnife.bind(this);


        getSupportActionBar().setTitle("CommitteeWise List");
        ...
        spin_committees.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String committee = getResources().getStringArray(R.array.committes)[position];
                loadVolunteers(committee);
            }
    ...
    private void loadVolunteers(final String committee) {
        MyApplication.getFirebaseDatabase().getReference(Constants.DB_PATH+"/Volunteers").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot indi : dataSnapshot.getChildren()) {
                    ...
                    if (volItem.getCommitte().equalsIgnoreCase(committee)){
                ...
                if (volunteerList.size()==0){
                    Constants.showToast("Members not Available",BoothwiseList.this);
                }
            }
